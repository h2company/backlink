		...
		<div class="content-wrapper">
			...
			<div class="content-header row">
				<div class="content-header-left col-md-4 col-12 mb-2">
					<h3 class="content-header-title">Doanh thu - Doanh Thu Quảng Cáo</h3>
				</div>
						...
						<div class="breadcrumb-wrapper mr-1">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.html">Trang
										chủ</a></li>
								<li class="breadcrumb-item"><a href="#">Quản Lý Doanh Thu</a></li>
								<li class="breadcrumb-item active">Doanh Thu Quảng Cáo</li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="card-content collapse show">
								<div class="table-responsive">
									<table class="table table-bordered table-striped">
										...
										<tbody>
											<tr>
												<td colspan="6" class="text-center">Chưa phát sinh giao dịch</td>
											</tr>
										</tbody>
									</table>
								</div>
