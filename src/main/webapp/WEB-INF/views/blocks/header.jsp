            ...
            <ul class="nav navbar-nav float-right">         
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="app-assets\images\portrait\small\avatar-s-19.png" alt="avatar"></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="app-assets\images\portrait\small\avatar-s-19.png" alt="avatar"><span class="user-name text-bold-700 ml-1">${sessionScope.auth.accountInfo.fullname}</span></span></a>
                    ...
                    <div class="dropdown-divider"></div><a class="dropdown-item" href="./logout.html"><i class="ft-power"></i> Logout</a>
                  </div>
                </div>
              </li>
            </ul>
