						...
						<div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
							<div class="card border-grey border-lighten-3 px-1 py-1 m-0">
								<div class="card-header border-0 mtb-5">
									...
									<div class="font-large-1  text-center">Đăng Ký Thành Viên
									</div>
								</div>
										...
										<form class="form-horizontal" action="register.html"
											...
											<fieldset class="form-group position-relative has-icon-left">
												<input type="text" class="form-control round" id="user-name"
													name="fullname" placeholder="Họ và tên" required=""  value="${account.accountInfo.fullname}">
											...
											<fieldset class="form-group position-relative has-icon-left">
												<input type="email" class="form-control round" name="email"
													id="user-email" placeholder="Địa chỉ email" required="" value="${account.email}">
												<div class="form-control-position">
													<i class="ft-mail"></i>
												</div>
											</fieldset>
											<fieldset class="form-group position-relative has-icon-left">
												<input type="text" class="form-control round" name="phone"
													id="user-phone" placeholder="Số điện thoại" required=""  value="${account.phone}">
												<div class="form-control-position">
													<i class="ft-phone"></i>
												</div>
											</fieldset>
											<fieldset class="form-group position-relative has-icon-left">
												<input type="text" class="form-control round"
													name="username" id="user-account" placeholder="Tài khoản"
											...
											<fieldset class="form-group position-relative has-icon-left">
												<input type="password" class="form-control round"
													name="repassword" id="user-repassword"
                        ...
                        <a href="#" class="btn btn-social-icon round mr-1 mb-1 btn-instagram">
                            <span class="ft-instagram"></span>
									...
									<p
										...
										<span>Bạn đã là thành viên <a href="login.html"
											class="card-link">Đăng nhập</a>
										</span>
									</p>
								</div>
							</div>
