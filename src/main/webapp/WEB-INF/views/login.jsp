...
<title>Đăng Nhập Thành Viên</title>
...
<link rel="stylesheet" type="text/css"
	href="app-assets\css\pages\login-register.min.css">
<!-- END: Page CSS-->
...
<body
	...
	data-color="bg-gradient-x-purple-blue" data-col="1-column">
	<!-- BEGIN: Content-->
						...
						<div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
							<div class="card border-grey border-lighten-3 px-1 py-1 m-0">
								<div class="card-header border-0">
									...
									<div class="font-large-1  text-center">Đăng Nhập</div>
								</div>
								<div class="card-content">
										...
										<form class="form-horizontal" action="login.html"
											...
											<fieldset class="form-group position-relative has-icon-left">
												<input type="text" class="form-control round" id="user-name"
													name="username" placeholder="Tên đăng nhập" required="" value="${username}">
											...
											<fieldset class="form-group position-relative has-icon-left">
												<input type="password" class="form-control round"
													id="user-password" name="password" placeholder="Mật khẩu"
													required="">
												<div class="form-control-position">
													<i class="ft-lock"></i>
												</div>
											...
											<div class="form-group row">
												...
												<div
													...
													<a href="recover-password.html" class="card-link">Quên
														mật khẩu?</a>
												</div>
											</div>
											<div class="form-group text-center">
												<button type="submit"
													class="btn round btn-block btn-glow btn-bg-gradient-x-purple-blue col-12 mr-1 mb-1">Đăng
													nhập</button>
											</div>
									...
									<div class="text-center">
										<a href="#"
											class="btn btn-social-icon round mr-1 mb-1 btn-facebook"><span
											class="ft-facebook"></span></a> <a href="#"
											class="btn btn-social-icon round mr-1 mb-1 btn-twitter"><span
											class="ft-twitter"></span></a> <a href="#"
											class="btn btn-social-icon round mr-1 mb-1 btn-instagram"><span
											class="ft-instagram"></span></a>
									</div>

									<p
										class="card-subtitle text-muted text-right font-small-3 mx-2 my-1">
										<span>Bạn chưa có tài khoản ? <a href="register.html"
											class="card-link">Đăng ký</a></span>
									</p>
								</div>
							</div>
						</div>
	...
	<!-- BEGIN: Page JS-->
	<script src="app-assets\js\scripts\forms\form-login-register.min.js"
		type="text/javascript"></script>
	<!-- END: Page JS-->
