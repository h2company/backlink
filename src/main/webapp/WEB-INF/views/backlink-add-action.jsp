		...
		<div class="content-wrapper">
			...
			<div class="content-header row">
				<div class="content-header-left col-md-4 col-12 mb-2">
					<h3 class="content-header-title">Backlink - Thêm mới Yêu Cầu Hành Động</h3>
				</div>
						...
						<div class="breadcrumb-wrapper mr-1">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="#">Quản Lý
										Backlink</a></li>
								<li class="breadcrumb-item active">Thêm mới Yêu Cầu Hành Động</li>
							</ol>
						</div>
					</div>
				</div>
									...
									<form class="form form-horizontal"
										...
										<div class="form-body">
											<h4 class="form-section">
												<i class="ft-clipboard"></i>Thông Tin Hành Động
											</h4>
											<div class="form-group row">
												<label class="col-md-3 label-control" for="projectinput5"><span
													style="color: red">(*)</span> Đường dẫn yêu cầu</label>
												<div class="col-md-9">
													<input type="text" id="projectinput5" class="form-control"
														value="" name="username"
														placeholder="Ví dụ: http://h2team.blog/gioi-thieu-ve-h2team.hmtl">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 label-control" for="projectinput5"><span
													style="color: red">(*)</span> Kênh tìm kiếm hợp lệ</label>
												<div class="col-md-9">
													<textarea class="form-control" id="descTextarea" rows="3"
														placeholder="Ví dụ: google.com , bing.com, yahoo.com..."></textarea>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 label-control" for="projectinput5"><span
													style="color: red">(*)</span> Từ khóa tìm kiếm hợp lệ</label>
												<div class="col-md-9">
													<textarea class="form-control" id="descTextarea" rows="3"
														placeholder="Ví dụ: h2team , h2 team,..."></textarea>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 label-control" for="projectinput5"><span
													style="color: red">(*)</span> Danh sách trình duyệt hợp lệ</label>
												<div class="col-md-9">
													<textarea class="form-control" id="descTextarea" rows="3"
														placeholder="Ví dụ: Chrome , Opera, Firefox,..."></textarea>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 label-control" for="projectinput5"><span
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="checkbox" id="switcheryColor"
														class="switchery" data-color="primary"
														data-secondary-color="primary" checked/=""> <label
														for="switcheryColor" class="card-title ml-1">Chặn
														trình thu thập dữ liệu</label>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 label-control" for="projectinput5"></label>
												<div class="col-md-9">
													<input type="checkbox" id="switcheryColor"
														class="switchery" data-color="primary"
														data-secondary-color="primary" checked/=""> <label
														for="switcheryColor" class="card-title ml-1">Lọc
														truy cập ảo</label>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="checkbox" id="switcheryColor"
														class="switchery" data-color="primary"
														data-secondary-color="primary" checked/=""> <label
														for="switcheryColor" class="card-title ml-1">Lưu
														thông tin truy cập</label>
												</div>
											</div>
										</div>
